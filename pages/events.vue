...
<section>
  ...
  <h3 class="text-center mb-5">Events</h3>
  ...
  <div class="row flex-column">
    <div class="col-md-12 col-lg-8 col-xl-5 mb-4 mx-auto">
      <div class="card hover-shadow-light">
        <div class="card-body">
          ...
          <p class="text-muted mt-3">
            ...
            <strong class="font-weight-bold">John Doe - CEO of XYZ</strong>
          </p>
          <div class="row pt-2">
      ...
      <div class="card hover-shadow-light">
        <div class="card-body">
          ...
          <p class="text-muted mt-3">
            ...
            <strong class="font-weight-bold">Maria Wiliams - CEO of Intel</strong>
          </p>
          <div class="row pt-2">
            <div class="col-md-3 col-3">
              <div class="mx-auto">
